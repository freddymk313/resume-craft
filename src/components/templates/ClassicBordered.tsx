...
const ClassicBordered = ({ data }: Props) => {
  ...
  // Distribute skills into 4 columns
  const cols = 4;
  ...
  return (
    ...
    >
      {/* Outer border */}
      <div
        className="min-h-[1123px] mx-[18px] my-[18px] border border-[#2d2d2d]"
        style={{ padding: "50px 50px 40px 50px" }}
      >
        {/* NAME */}
        <div className="text-center mb-1">
          <h1
            className="font-bold uppercase tracking-[0.08em] text-[#1a1a1a]"
            style={{ fontSize: "38px", lineHeight: 1.1, fontFamily: "'Georgia', serif" }}
          >
        ...
        <div className="text-center mb-5">
          <p
            className="uppercase tracking-[0.25em] text-[#555]"
            style={{ fontSize: "14px", fontWeight: 400, fontFamily: "'Helvetica Neue', Arial, sans-serif" }}
          >
        ...
        {summary && (
          <div className="mb-7">
            <h2
              className="font-bold uppercase text-[#1a1a1a] mb-1"
            ...
            <p
              className="text-[#404040] leading-relaxed text-justify"
              style={{ fontSize: "11px", lineHeight: "1.65", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}
            >
              {summary}
            </p>
          </div>
              ...
              {education.map((edu) => (
                <div key={edu.id} className="flex gap-6">
                  <div className="w-[160px] flex-shrink-0">
                    ...
                    <p className="text-[#555]" style={{ fontSize: "11px", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
                      {edu.school}
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-4 gap-x-6 gap-y-2">
              {skillsList.map((skill, i) => (
                <div key={i} className="flex items-start gap-2">
                  ...
                  <span className="text-[#404040]" style={{ fontSize: "11px", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
                    {skill}
                  </span>
                </div>
              ))}
